...
-- CreateEnum
CREATE TYPE "DocumentType" AS ENUM ('EMPLOYEE', 'VEHICLE', 'VENDOR', 'INSURANCE', 'LICENSE', 'OTHER');

-- CreateEnum
CREATE TYPE "DocumentStatus" AS ENUM ('ACTIVE', 'EXPIRING_SOON', 'EXPIRED');
...
-- CreateIndex
CREATE INDEX "DocumentAlert_documentId_idx" ON "DocumentAlert"("documentId");
...
-- AddForeignKey
ALTER TABLE "DocumentAlert" ADD CONSTRAINT "DocumentAlert_documentId_fkey" FOREIGN KEY ("documentId") REFERENCES "Document"("id") ON DELETE CASCADE ON UPDATE CASCADE;
